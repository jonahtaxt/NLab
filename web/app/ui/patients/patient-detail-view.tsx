...
import AppointmentNotes from "@/app/ui/appointments/appointment-notes";
import PatientPersonalData from "@/app/ui/patients/patient-personal-data";
        ...
        <div className="flex flex-col gap-4 p-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="md:col-span-1">
              <PatientPersonalData patient={patient} handleAddAppointment={handleAddAppointment} />
            </div>
