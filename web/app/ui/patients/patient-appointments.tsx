            ...
            <tr key={appointment.appointmentId} className="border-b hover:bg-gray-50">
                ...
                <td className="px-4 py-3 text-sm">
                    <div className="flex items-center justify-center space-x-2">
                        <Button variant="ghost" onClick={() => alert('caca')} className="h-8 w-8 p-1" title="Reagendar cita">
                        ...
                        <Button variant="ghost" onClick={() => alert('caca')} className="h-8 w-8 p-1" title="Agregar notas">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
